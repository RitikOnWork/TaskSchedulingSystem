...
public class ProjectDAO {
    ...
    private static final String SELECT_ALL =
            "SELECT project_id, title, deadline, revenue FROM projects ORDER BY created_at";

    private static final String SELECT_BY_ID =
            "SELECT project_id, title, deadline, revenue FROM projects WHERE project_id = ?";
    ...
    public Project addProject(String title, int deadline, double revenue) throws SQLException {
        ...
        return new Project(id, title, deadline, revenue);
    }
